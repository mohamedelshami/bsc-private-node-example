...
contract('Precompiles', function (accounts) {
  ...
  it("should execute sha3fips Precompiled fucntion", function () {
    ...
    return Precompiles.deployed().then(function (instance) {
      ...
      assert.equal(balance, 0xc7647f7e251bf1bd70863c8693e93a4e77dd0c9a689073e987d51254317dc704, "The output value is different than expected");
    });
  });
  ...
  it("should execute ecrecoverPublicKey Precompiled fucntion", function () {
    ...
    return Precompiles.deployed().then(function (instance) {
      ...
      assert.equal(balance, 0x0448250ebe88d77e0a12bcf530fe6a2cf1ac176945638d309b840d631940c93b78c2bd6d16f227a8877e3f1604cd75b9c5a8ab0cac95174a8a0a0f8ea9e4c10bca, "The output value is different than expected");
    });
